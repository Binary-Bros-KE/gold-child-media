          ...
          <div className="flex justify-between items-center h-15">
            ...
            <div className="flex space-x-4 h-full">
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                href="/apply"
                className="flex items-center justify-center bg-primary text-white px-6 py-2 cursor-pointer font-semibold hover:from-primary hover:to-primary transition-all duration-300 shadow-lg max-md:hidden"
          ...
          {isOpen && (
            ...
            >
              <div className="container mx-auto px-4 py-4 space-y-4">
                ...
                {/* apply now action button should be bright primary bg button  */}
                <motion.a
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  href="/apply"
                  className="block text-white bg-primary hover:bg-primary-dark font-medium py-2 px-4 rounded transition-colors mt-10"
                >
                  Apply Now
                </motion.a>
              </div>

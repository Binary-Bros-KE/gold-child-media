    ...
    <>
      ...
      <div className="bg-secondary text-white">
        <div className="container mx-auto flex flex-col md:flex-row justify-between items-center text-sm">
          {/* Social Links */}
          <div className="flex items-center space-x-4 mb-2 md:mb-0 bg-[url('/graphics/rectangle.png')] bg-cover bg-center py-6 px-20">
          ...
          <div className="flex justify-between items-center h-15">
            ...
            <div className="flex space-x-4 h-full">
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="bg-primary text-white px-6 py-2 cursor-pointer font-semibold hover:from-orange-500 hover:to-orange-600 transition-all duration-300 shadow-lg"
              >
                ADMISSION OPEN
              </motion.button>

                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="space-y-6 flex gap-4 h-full">
                        ...
                        <div className="flex flex-col gap-4">
                            {/*change Stats Box to image*/}
                            <div className="relative max-w-sm h-full max-h-50">
                                <div className="rounded-3xl overflow-hidden border-4 border-teal-600 shadow-lg h-full">
                                    <img
                                        src="/index/about.jpeg"
                                        alt="Goldchild Media Institute Stats"
                                        className="w-full h-full object-cover bg-gray-200"
                                    />
                                </div>
                            </div>

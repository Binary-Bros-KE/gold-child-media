          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a href="/apply" className="bg-primary hover:bg-primary text-white px-8 py-4 rounded-full font-semibold transition-colors flex items-center justify-center gap-2">
                  <Phone className="w-5 h-5" />
                  Enroll Now
                </a>
                {/* use contact modal to open contact form */}
                <button onClick={openContactModal} className="border-2 border-gray-300 hover:border-primary text-gray-700 hover:text-primary px-8 py-4 rounded-full font-semibold transition-colors flex items-center justify-center gap-2 cursor-pointer">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-white border-2 border-gray-100 rounded-2xl p-8 sticky top-8">
                ...
                <div className="mt-8 space-y-4">
                  {/* button directs to href="/apply"  */}
                  <a href="/apply" className="w-full bg-primary hover:bg-primary text-white py-4 rounded-full font-semibold transition-colors flex items-center justify-center gap-2">
                    Enroll Now
                  </a>
                  {/* use contact modal to open contact form */}
                  <button onClick={openContactModal} className="w-full border-2 border-gray-300 hover:border-primary text-gray-700 hover:text-primary py-4 rounded-full font-semibold transition-colors cursor-pointer">
                    Contact Us
                  </button>
                </div>
              </div>
